...
<body>
    ...
    <div class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="{{ route ('cart') }}" class="sidebar-nav-link active"><i class="fas fa-cart-plus"></i> Keranjang Saya</a>
                ...
                if (cartItems.length > 0) {
                    ...
                    cartItemsContainer.innerHTML = `
                        <div class="empty-cart">
                            ...
                            <a href="{{route(('index'))}}" class="checkout-btn" style="display: inline-block; margin-top: 20px;">
