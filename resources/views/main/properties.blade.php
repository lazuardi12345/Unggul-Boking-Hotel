...
- Kids club & babysitting"
        ...
        <div class="section">
            ...
            <div class="hotel-grid">
                <!-- Hotel Card 1 -->
                <div class="hotel-card">
                    <img src="/assets/img/spencer_green_hotel.jpg" alt="Spencer Green Hotel">
                ...
                <!-- Hotel Card 2 -->
                <div class="hotel-card">
                    <img src="/assets/img/royal-ambarukmo.jpg" alt="Royal Ambarrukmo">
                    <div class="rating">4.8 <i class='bx bxs-star'></i></div>
                    <div class="card-content">
                        <h3>Royal Ambarrukmo</h3>
                        <p><i class='bx bxs-map'></i> Jogjakarta</p>
                ...
                <!-- Hotel Card 3 -->
                <div class="hotel-card">
                    <img src="/assets/img/hotel trikora beach.jpg" alt="Hotel Trikora Beach">
                    ...
                    <div class="card-content">
                        ...
                        <div class="profile-and-button">
                            ...
                            <form action="{{route('booking-properties')}}" method="POST">
                                ...
                                <input type="hidden" name="image" value="/assets/img/hotel_trikora_beach.jpg">
                                <button type="submit" class="pesan-kamar-btn">Pesan Kamar</button>
                            </form>
                            <button class="add-to-cart-btn" 
                ...
                <!-- Hotel Card 4 -->
                <div class="hotel-card">
                    <img src="/assets/img/HotelSantika.jpg" alt="Hotel Santika Prime">
                    <div class="rating">4.5 <i class='bx bxs-star'></i></div>
                    <div class="card-content">
                        <h3>Hotel Santika Prime</h3>
                        <p><i class='bx bxs-map'></i> Harapan Indah Bekasi</p>
                ...
                <!-- Hotel Card 5 -->
                <div class="hotel-card">
                    <img src="/assets/img/hotelContinental.jpg" alt="Hotel Continental">
                    ...
                    <div class="card-content">
                        ...
                        <div class="profile-and-button">
                            ...
                            <form action="{{route('booking-properties')}}" method="POST">
                                ...
                                <input type="hidden" name="image" value="/assets/img/hotel_continental.jpg">
                                <button type="submit" class="pesan-kamar-btn">Pesan Kamar</button>
                            </form>
                            <button class="add-to-cart-btn" 
                ...
                <!-- Hotel Card 6 -->
                <div class="hotel-card">
                    <img src="/assets/img/HotelNovotel.jpg" alt="Hotel Novotel Bandung">
                    <div class="rating">4.6 <i class='bx bxs-star'></i></div>
                    <div class="card-content">
                        <h3>Hotel Novotel</h3>
                        <p><i class='bx bxs-map'></i> Bandung</p>
                        ...
                        <div class="profile-and-button">
                            ...
                            <form action="{{route('booking-properties')}}" method="POST">
                                ...
                                <input type="hidden" name="price" value="853801">
                                <input type="hidden" name="rating" value="4.6">
                                <input type="hidden" name="image" value="/assets/img/novotel.jpg">
                                <button type="submit" class="pesan-kamar-btn">Pesan Kamar</button>
                            </form>
                            <button class="add-to-cart-btn" 
                                data-hotel='{"name": "Hotel Novotel", "location": "Bandung", "price": "Rp. 853.801", "image": "novotel.jpg", "rating": "4.6"}'>
    ...
    <script>
        ...
        document.querySelector('.login-btn').addEventListener('click', function() {
            window.location.href = '{{route('user-selection')}}';
        });
    </script>
</body>
</html> 