...
<body>
    <div class="profile-container">
        <header class="profile-header">
            <a href="{{ route('index') }}" class="back-arrow"><i class="fas fa-arrow-left"></i> Kembali</a>
        </header>
        <div class="profile-content">
            <div class="profile-picture-section">
                <img src="/assets/img/profil.jpg" alt="Profile Picture" class="profile-picture" id="profile-picture-preview">
            ...
            <button class="logout-btn" onclick="window.location.href='{{ route('login') }}'~"><i class="fas fa-sign-out-alt"></i> Logout</button>
        </div>
    </div>
    <script>
