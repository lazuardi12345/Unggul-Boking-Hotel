        ...
        <div class="section">
            ...
            <div class="hotel-grid">
                ...
                <div class="hotel-card">
                    <img src="/assets/img/HotelSantika.jpg" alt="Hotel Santika Prime" class="hotel-image"
...
- Laundry & dry cleaning service"
                    data-images='["/assets/img/santika-room1.jpg", "/assets/img/santika-room2.jpg", "/assets/img/santika-room3.jpg", "/assets/img/santika-room4.jpg"]'>
                    ...
                    <div class="card-content">
                        ...
                        <div class="profile-and-button">
                            <div class="profile">
                                <img src="/assets/img/larrynaves.png" alt="Larry Naves">
                                <span>Larry Naves</span>
                            </div>
                            <form action="{{route('booking-properties')}}" method="POST">
                                @csrf
                                ...
                                <input type="hidden" name="image" value="/assets/img/HotelSantika.jpg">
                ...
                <!-- Hotel Card 2 -->
                <div class="hotel-card">
                    <img src="/assets/img/royal-ambarukmo.jpg" alt="Royal Ambarrukmo" class="hotel-image"
...
- Traditional massage service"
                    data-images='["/assets/img/ambarrukmo-room1.jpg", "/assets/img/ambarrukmo-room2.jpg", "/assets/img/ambarrukmo-room3.jpg", "/assets/img/ambarrukmo-room4.jpg"]'>
                    ...
                    <div class="card-content">
                        ...
                        <div class="profile-and-button">
                            <div class="profile">
                                <img src="/assets/img/robert.png" alt="Robert">
                                <span>Robert</span>
                            </div>
                            <form action="booking_properties.php" method="POST">
                                ...
                                <input type="hidden" name="image" value="/assets/img/royal-ambarukmo.jpg">
                                <button type="submit" class="pesan-kamar-btn">Pesan Kamar</button>
                            </form>
                            <button class="add-to-cart-btn" 
                ...
                <!-- Hotel Card 3 -->
                <div class="hotel-card">
                    <img src="/assets/img/HotelNovotel.jpg" alt="Hotel Novotel" class="hotel-image"
...
- Kids club & babysitting"
                    data-images='["/assets/img/novotel-room1.jpg", "/assets/img/novotel-room2.jpg", "/assets/img/novotel-room3.jpg", "/assets/img/novotel-room4.jpg"]'>
                    ...
                    <div class="card-content">
                        ...
                        <div class="profile-and-button">
                            <div class="profile">
                                <img src="/assets/img/Jessica.png" alt="Jessica">
                                <span>Jessica</span>
                            </div>
                            <form action="booking_properties.php" method="POST">
                                ...
                                <input type="hidden" name="image" value="/assets/img/HotelNovotel.jpg">
                                <button type="submit" class="pesan-kamar-btn">Pesan Kamar</button>
                            </form>
                            <button class="add-to-cart-btn" 
                                data-hotel='{"name": "Hotel Novotel", "location": "Bandung", "price": "Rp. 653.801", "image": "HotelNovotel.jpg", "rating": "4.6"}'>
                                <i class="bx bx-cart"></i>
                            </button>
                        </div>
                    </div>
                                ...
                                <!-- Hotel Card 4 -->
                <div class="hotel-card">
                    <img src="/assets/img/fairfield.jpg" alt="Hotel Fairfield" class="hotel-image"
...
- Business services
- Kids club & babysitting"
                    data-images='["/assets/img/Fairfield-room1.jpg", "/assets/img/Fairfield-room2.jpg", "/assets/img/Fairfield-room3.jpg", "/assets/img/Fairfield-room4.jpg"]'>
                    <div class="rating">4.6 <i class='bx bxs-star'></i></div>
                    <div class="card-content">
                        ...
                        <div class="profile-and-button">
                            <div class="profile">
                                <img src="/assets/img/jefrinichol.png" alt="Jefri Nichol">
                ...
                <!-- Hotel Card 5 -->
                <div class="hotel-card">
                    <img src="/assets/img/HotelKempinski.jpg" alt="Hotel Kempinski" class="hotel-image"
...
- Layanan laundry
- Parkir gratis"
                    data-images='["/assets/img/Kempinski-room1.jpg", "/assets/img/Kempinski-room2.jpg", "/assets/img/Kempinski-room3.jpg", "/assets/img/Kempinski-room4.jpg"]'>
                    <div class="rating">4.5 <i class='bx bxs-star'></i></div>
                    <div class="card-content">
                        ...
                        <div class="profile-and-button">
                            <div class="profile">
                                <img src="/assets/img/marcovanbasten.png" alt="Marco Van Basten">
                            ...
                            <form action="booking_properties.php" method="POST">
                                ...
                                <input type="hidden" name="rating" value="4.5">
                                <input type="hidden" name="image" value="/assets/img/holiday-inn.jpg">
                                <button type="submit" class="pesan-kamar-btn">Pesan Kamar</button>
                            </form>
                            <button class="add-to-cart-btn" 
                                data-hotel='{"name": "Hotel Kempinski", "location": "Jakarta Pusat", "price": "Rp. 688.750", "image": "HotelKempinski.jpg", "rating": "4.5"}'>
                                <i class="bx bx-cart"></i>
                            </button>
                        </div>
                    </div>
        ...
        <div class="section">
            ...
            <div class="hotel-grid">
                <!-- Hotel Card 1 -->
                <div class="hotel-card">
                    <img src="/assets/img/spencer_green_hotel.jpg" alt="Hotel Spencer Green" class="hotel-image"
...
- Wi-Fi gratis di seluruh properti."
                    data-images='["/assets/img/Spencer Green-room1.jpg", "/assets/img/Spencer Green-room2.jpg", "/assets/img/Spencer Green-room3.jpg", "/assets/img/Spencer Green-room4.jpg"]'>
                    ...
                    <div class="card-content">
                        ...
                        <div class="profile-and-button">
                            ...
                            <form action="booking_properties.php" method="POST">
                                ...
                                <input type="hidden" name="image" value="/assets/img/spencer_green_hotel.jpg">
                                <button type="submit" class="pesan-kamar-btn">Pesan Kamar</button>
                            </form>
                            <button class="add-to-cart-btn" 
                ...
                <!-- Hotel Card 2 -->
                <div class="hotel-card">
                    <img src="/assets/img/Hotel aston bekasi.jpg" alt="Hotel Aston" class="hotel-image"
...
- Executive lounge access"
                    data-images='["/assets/img/Aston Bekasi-room1.jpg", "/assets/img/Aston Bekasi-room2.jpg", "/assets/img/Aston Bekasi-room3.jpg", "/assets/img/Aston Bekasi-room4.jpg"]'>
                    ...
                    <div class="card-content">
                        ...
                        <div class="profile-and-button">
                            ...
                            <form action="booking_properties.php" method="POST">
                                ...
                                <input type="hidden" name="image" value="/assets/img/Hotel aston bekasi.jpg">
                                <button type="submit" class="pesan-kamar-btn">Pesan Kamar</button>
                            </form>
                            <button class="add-to-cart-btn" 
                ...
                <!-- Hotel Card 3 -->
                <div class="hotel-card">
                    <img src="/assets/img/Hotel trikora beach.jpg" alt="Trikora Beach" class="hotel-image"
...
- Kelas memasak dan masakan lokal"
                    data-images='["/assets/img/Trikora Beach-room1.jpg", "/assets/img/Trikora Beach-room2.jpg", "/assets/img/Trikora Beach-room3.jpg", "/assets/img/Trikora Beach-room4.jpg"]'>
                    <div class="rating">4.9 <i class='bx bxs-star'></i></div>
                    <div class="card-content">
                        ...
                        <div class="profile-and-button">
                            ...
                            <form action="booking_properties.php" method="POST">
                                ...
                                <input type="hidden" name="rating" value="4.9">
                                <input type="hidden" name="image" value="/assets/img/Hotel trikora beach.jpg">
                                <button type="submit" class="pesan-kamar-btn">Pesan Kamar</button>
                            </form>
                            <button class="add-to-cart-btn" 
                ...
                <!-- Hotel Card 4 -->
                <div class="hotel-card">
                    <img src="/assets/img/HotelSantika.jpg" alt="Hotel Santika" class="hotel-image"
...
- Exclusive club access"
                    ...
                    <!-- Hotel Card 5 -->
                <div class="hotel-card">
                    <img src="/assets/img/HotelContinental.jpg" alt="Hotel Continental" class="hotel-image"
...
- Valet Parking
- Wifi gratis"
                    data-images='["/assets/img/Continental-room1.jpg", "/assets/img/Continental-room2.jpg", "/assets/img/Continental-room3.jpg", "/assets/img/Continental-room4.jpg"]'>
                    <div class="rating">4.9 <i class='bx bxs-star'></i></div>
                    <div class="card-content">
                        ...
                        <div class="profile-and-button">
                            ...
                            <form action="booking_properties.php" method="POST">
                                ...
                                <input type="hidden" name="price" value="8000000">
                                <input type="hidden" name="rating" value="4.9">
                                <input type="hidden" name="image" value="/assets/img/HotelContinental.jpg">
                                <button type="submit" class="pesan-kamar-btn">Pesan Kamar</button>
                            </form>
                            <button class="add-to-cart-btn" 
                    ...
                    <div class="card-content">
                        ...
                        <div class="profile-and-button">
                            ...
                            <form action="booking_properties.php" method="POST">
                                ...
                                <input type="hidden" name="price" value="8000000">
                                <input type="hidden" name="rating" value="4.9">
                                <input type="hidden" name="image" value="/assets/img/fairfield.jpg">
                                <button type="submit" class="pesan-kamar-btn">Pesan Kamar</button>
                            </form>
                            <button class="add-to-cart-btn" 
                        ...
                        <!-- Hotel Card 8 -->
                <div class="hotel-card">
                    <img src="/assets/img/The Phoneix Hotel.jpg" alt="Hotel The Phoneix" class="hotel-image"
                    data-description="The Ritz-Carlton Jakarta menawarkan kemewahan tertinggi:
...
- Personal shopping & styling
- Exclusive club access"
                    data-images='["/assets/img/The Phoneix-room1.jpg", "/assets/img/The Phoneix-room2.jpg", "/assets/img/The Phoneix-room3.jpg", "/assets/img/The Phoneix-room4.jpg"]'>
                    <div class="rating">4.9 <i class='bx bxs-star'></i></div>
                    <div class="card-content">
                        ...
                        <div class="profile-and-button">
                            ...
                            <form action="booking_properties.php" method="POST">
                                ...
                                <input type="hidden" name="price" value="8000000">
                                <input type="hidden" name="rating" value="4.9">
                                <input type="hidden" name="image" value="/assets/img/The Phoneix Hotel.jpg">
                                <button type="submit" class="pesan-kamar-btn">Pesan Kamar</button>
                            </form>
                            <button class="add-to-cart-btn" 
                        ...
                        <!-- Hotel Card 9 -->
                <div class="hotel-card">
                    <img src="/assets/img/Hotel bali resort.jpg" alt="Hotel Bali Resort" class="hotel-image"
...
- Layanan penitipan anak (atas permintaan)"
                    data-images='["/assets/img/Bali Resort-room1.jpg", "/assets/img/Bali Resort-room2.jpg", "/assets/img/Bali Resort-room3.jpg", "/assets/img/Bali Resort-room4.jpg"]'>
                    <div class="rating">4.9 <i class='bx bxs-star'></i></div>
                    <div class="card-content">
                        ...
                        <div class="profile-and-button">
                            ...
                            <form action="booking_properties.php" method="POST">
                                ...
                                <input type="hidden" name="price" value="8000000">
                                <input type="hidden" name="rating" value="4.9">
                                <input type="hidden" name="image" value="/assets/img/Hotel bali resort.jpg">
                                <button type="submit" class="pesan-kamar-btn">Pesan Kamar</button>
                            </form>
                            <button class="add-to-cart-btn" 
                    ...
                    <div class="card-content">
                        ...
                        <div class="profile-and-button">
                            ...
                            <form action="booking_properties.php" method="POST">
                                ...
                                <input type="hidden" name="price" value="8000000">
                                <input type="hidden" name="rating" value="4.9">
                                <input type="hidden" name="image" value="/assets/img/HotelKempinski.jpg">
                                <button type="submit" class="pesan-kamar-btn">Pesan Kamar</button>
                            </form>
                            <button class="add-to-cart-btn" 
                                data-hotel='{"name": "Hotel Kempinski", "location": "Jakarta Pusat", "price": "Rp. 688.750", "image": "HotelKempinski.jpg", "rating": "4.9"}'>
                                <i class="bx bx-cart"></i>
                            </button>
                        </div>
                    </div>
                        ...
                        <!-- Hotel Card 11 -->
                <div class="hotel-card">
                    <img src="/assets/img/raffles.jpg" alt="Hotel Raffles" class="hotel-image"
...
- Akses eksklusif ke fasilitas club (untuk tamu tertentu)"
                    data-images='["/assets/img/Raffles-room1.jpg", "/assets/img/Raffles-room2.jpg", "/assets/img/Raffles-room3.jpg", "/assets/img/Raffles-room4.jpg"]'>
                    <div class="rating">4.9 <i class='bx bxs-star'></i></div>
                    <div class="card-content">
                        <h3>Hotel Raffles</h3>
                        ...
                        <div class="profile-and-button">
                            ...
                            <form action="booking_properties.php" method="POST">
                                ...
                                <input type="hidden" name="price" value="8000000">
                                <input type="hidden" name="rating" value="4.9">
                                <input type="hidden" name="image" value="/assets/img/raffles.jpg">
                                <button type="submit" class="pesan-kamar-btn">Pesan Kamar</button>
                            </form>
                            <button class="add-to-cart-btn" 
                        ...
                        <!-- Hotel Card 12 -->
                <div class="hotel-card">
                    <img src="/assets/img/ritz-carlton.jpg" alt="The Ritz-Carlton" class="hotel-image"
                    data-description="The Ritz-Carlton Jakarta menawarkan kemewahan tertinggi:
...
- Personal shopping & styling
- Exclusive club access"
                    data-images='["/assets/img/ritz-room1.jpg", "/assets/img/ritz-room2.jpg", "/assets/img/ritz-room3.jpg", "/assets/img/ritz-room4.jpg"]'>
                    <div class="rating">4.9 <i class='bx bxs-star'></i></div>
                    <div class="card-content">
                        ...
                        <div class="profile-and-button">
                            ...
                            <form action="booking_properties.php" method="POST">
                                ...
                                <input type="hidden" name="price" value="8000000">
                                <input type="hidden" name="rating" value="4.9">
                                <input type="hidden" name="image" value="/assets/img/ritz-carlton.jpg">
                                <button type="submit" class="pesan-kamar-btn">Pesan Kamar</button>
                            </form>
                            <button class="add-to-cart-btn" 
                        ...
                        <!-- Hotel Card 13 -->
                <div class="hotel-card">
                    <img src="/assets/img/royal-ambarukmo.jpg" alt="royal-ambarukmo" class="hotel-image"
                    data-description="Royal Ambarrukmo adalah hotel bersejarah dengan kemewahan modern:
...
- Traditional massage service"
                    ...
                    <div class="card-content">
                        ...
                        <!-- Hotel Card 14 -->
                <div class="hotel-card">
                    <img src="/assets/img/HotelFave.jpg" alt="hotel-fave" class="hotel-image"
...
- Deluxe Premier Room
- Deluxe Family Room"
                    data-images='["/assets/img/Fave Malang-room1.jpg", "/assets/img/Fave Malang-room2.jpg", "/assets/img/Fave Malang-room3.jpg", "/assets/img/Fave Malang-room4.jpg"]'>
                    <div class="rating">4.9 <i class='bx bxs-star'></i></div>
                    <div class="card-content">
