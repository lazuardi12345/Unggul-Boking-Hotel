                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    //     $img_path = '/assets/img/default-hotel.jpg'; // fallback jika gambar tidak ada
                                    // }
                                    ?>
                                    <!-- <img src="/assets/img/HotelSantika.jpg" width="100" style="border:1px solid red"> -->
                                    <img src="<?= $img_web ?>" alt="<?= htmlspecialchars($hotel['name']) ?>" class="hotel-photo">
                                </td>
...
function hideForm() {
    window.location.href = '{{route('admin-location')}}';
}
</script>
</html> 